...
import GoBackIcon from '@assets/img/left-arrow.png';
...
const FormBanner = ({ goBack, title }: Props): ReactElement => {
    return (
        <View style={styles.svgContainer}>
            ...
            <TouchableOpacity style={styles.goBackIconContent} onPress={goBack}>
